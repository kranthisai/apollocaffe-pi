...
LIBRARIES += glog gflags protobuf leveldb snappy lmdb boost_system opencv_core opencv_highgui opencv_imgproc boost_filesystem m hdf5_serial_hl hdf5_serial
